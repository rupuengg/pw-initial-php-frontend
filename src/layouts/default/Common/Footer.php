...
<div class="footer">
  <div class="main_box">
    <ul>
      ...
      <li class="middle">
        <p>
          <span class="" style="display: inline-flex; fill: rgb(255, 255, 255)"
        ...
        <p style="display: flex">
          <span style="display: flex; align-items: center; width: 12px"
            ><span
              class="whatsapp-icon"
          ...
          ><a
            target="_blank"
            href="https://wa.me/9599385377?text="
            rel="noreferrer"
            >+91-9599385377</a
          >
        </p>
      ...
      <li class="copy">Copyright © 2021 panacheworld.in. All right reserved</li>
    </ul>
  </div>
</div>
